...
-- ============================================================
-- OBJETIVO:
-- Criar uma tabela de fatos consolidada com os principais KPIs
-- econômicos, populacionais e climáticos por país, incluindo
-- cálculo de variação YoY (Year-over-Year) de forma correta.
-- ============================================================
...
-- ============================================================
-- 2. Seleciona apenas o ano mais recente ( com YoY calculado)
-- ============================================================
ultimo_ano as (
    select
        nome_pais,
        max(ano) as ano_recente
    from bm_yoy
    group by nome_pais
),

-- ============================================================
-- 3. Une com as dimensões auxiliares
-- ============================================================
bm_final as (
    select
        y.* 
    from bm_yoy y
    join ultimo_ano u 
      on y.nome_pais = u.nome_pais 
     and y.ano = u.ano_recente
)

-- ============================================================
-- 4. Seleção final com enriquecimento de dimensões
-- ============================================================
select distinct
    f.nome_pais,
    f.capital,
